...
``` shell
clojure -Sdeps '{:deps {lambdaisland/kaocha {:mvn/version "1.91.1458"}}}' -m kaocha.runner --test-help
```
...
{:deps { ,,, }
 ...
 {:test {:main-opts ["-m" "kaocha.runner"]
         :extra-deps {lambdaisland/kaocha {:mvn/version "1.91.1458"}}}}}
```
...
{:deps { ,,, }
 :aliases 
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.91.1458"}}
...
{:deps { ,,, }
 ...
 {:test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.91.1458"}}
         :exec-fn kaocha.runner/exec-fn
         :exec-args {}}
 :watch-test {:extra-deps {lambdaisland/kaocha {:mvn/version "1.91.1458"}}
         :exec-fn kaocha.runner/exec-fn
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:dev {:dependencies [,,, [lambdaisland/kaocha "1.91.1458"]]}}
...
(defproject my-proj "0.1.0"
  :dependencies [,,,]
  :profiles {:kaocha {:dependencies [[lambdaisland/kaocha "1.91.1458"]]}}
...
```clojure
{:paths ["src" "test"]
 :deps {lambdaisland/kaocha {:mvn/version "1.91.1458"}}}
